...
export const getEntities = createAsyncThunk('categories/fetch_entity_list', async ({ searchText, page, size, sort, filters }: IQueryParams) => {
...
export const createEntity = createAsyncThunk(
  ...
  async (entity: ICategory, thunkAPI) => {
    const result = await api.post<ICategory>(apiUrl, cleanEntity(entity));
    return result;
  },
  { serializeError: serializeAxiosError },
);
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: ICategory, thunkAPI) => {
    const result = await api.put<ICategory>(`${apiUrl}`, cleanEntity(entity));
    return result;
  },
  { serializeError: serializeAxiosError },
);
